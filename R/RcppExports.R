...
rcpp_cppDataFrameInterface <- function(x, y, catCols, splitCols, linCols, numRows, numColumns, sampleWeights, bootstrapWeights) {
    .Call(`_forestry_rcpp_cppDataFrameInterface`, x, y, catCols, splitCols, linCols, numRows, numColumns, sampleWeights, bootstrapWeights)
}
